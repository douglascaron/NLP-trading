...
def analyse_headlines(headline_content, headline_url, headline_ticker, sensitivity=1.0):
    ...
    headline_score = sia.polarity_scores(headline_content)['compound']
    headline_score *= sensitivity
    ...
    print(f'{Fore.YELLOW}[Sentiment Score]{Fore.RESET} {headline_score:.4f}')
    ...
    # Measure difference between headline sentiment and article sentiment
